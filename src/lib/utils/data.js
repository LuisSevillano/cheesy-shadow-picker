const shadows = [
	...
	},
	{
		...
		shadow: '0px 0px 1px #ffffff, 0px 0px 2px #ffffff, 0px 0px 3px #ffffff, 0px 0px 4px #ffffff;',
	...
	},
	{
		...
		shadow: '0px 0px 1px #ffffff, 0px 0px 2px #ffffff, 0px 0px 3px #ffffff, 0px 0px 4px #ffffff;',
		source:
			'https://www.nytimes.com/interactive/2022/world/europe/ukraine-maps.html?name=styln-russia-ukraine&region=TOP_BANNER&block=storyline_menu_recirc&action=click&pgtype=LegacyCollection&variant=0_Control&is_new=false'
	},
	{
		backgroundColor: '#ffffff',
		source: 'https://www.nytimes.com/interactive/2022/world/europe/ukraine-maps.html',
	...
	},
	{
		...
		shadow:
			'1px 1px 0px rgb(255 255 255 / 70%), -1px -1px 0px rgb(255 255 255 / 70%), -1px 1px 0px rgb(255 255 255 / 70%), 1px -1px 0px rgb(255 255 255 / 70%);'
	},

	{
		backgroundColor: '#ffffff',
		source: 'https://www.washingtonpost.com/graphics/2017/politics/alabama-election-analysis/ ',
		shadow: '0px 0px 2px #ffffff;'
	},
...

	{
		...
		shadow: '0px 0px 5px #ffffff, 0px 0px 5px #ffffff;'
	},

	{
		...
		shadow: '0 1px 0 #ffffff, 1px 0 0 #ffffff, 0 -1px 0 #ffffff, -1px 0 0 #ffffff !important;'
	},

	{
		...
		shadow: '0px 0px 3px #ffffff, 0px 0px 5px #ffffff, 0px 0px 10px #ffffff;'
	},

	{
		...
		shadow:
			'1px 1px 1px rgb(255 255 255 / 30%), -1px 1px 1px rgb(255 255 255 / 30%), 1px -1px 1px rgb(255 255 255 / 30%), -1px -1px 1px rgb(255 255 255 / 30%), 2px 2px 2px rgb(255 255 255 / 30%), -2px 2px 2px rgb(255 255 255 / 30%), 2px -2px 2px rgb(255 255 255 / 30%), -2px -2px 2px rgb(255 255 255 / 30%);'
	},

	{
		backgroundColor: '#000000',
		source: 'https://www.washingtonpost.com/nation/interactive/2021/weather-disasters-2021 ',
		shadow: '-2px 2px 6px #ffffff, 0 0 2px #ffffff, 2px 2px 6px #ffffff;'
	},
...

	{
		...
		shadow:
			'1px 1px 0px rgb(255 255 255 / 70%), 0px 1px 0px rgb(255 255 255 / 70%), -1px 1px 0px rgb(255 255 255 / 70%), -1px 0px 0px rgb(255 255 255 / 70%), -1px -1px 0px rgb(255 255 255 / 70%), 0px -1px 0px rgb(255 255 255 / 70%), 1px -1px 0px rgb(255 255 255 / 70%);'
	},
...
export default { cheeses, shadows };
